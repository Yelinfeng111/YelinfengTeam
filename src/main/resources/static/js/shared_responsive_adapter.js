...
function Responsive_BuildChangeLanguageOption( $MenuItem )
{
    $MenuItem.click( function() {
        ...
        $SelectBox.append(
            $J('<option/>', {value: "schinese"} ).text( 'ºÚÃÂ÷–Œƒ' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "bulgarian"} ).text( 'ß“ßÏß›ß‘ß—ß‚ß„ß‹ß⁄£®±£º”¿˚—«”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "czech"} ).text( '?e?tina£®Ω›øÀ”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "danish"} ).text( 'Dansk£®µ§¬Û”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "dutch"} ).text( 'Nederlands£®∫…¿º”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "english"} ).text( 'English£®”¢”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "finnish"} ).text( 'Suomi£®∑“¿º”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "french"} ).text( 'Fran?ais£®∑®”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "greek"} ).text( '¶•¶À¶À¶«¶Õ¶…¶ ?£®œ£¿∞”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "german"} ).text( 'Deutsch£®µ¬”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "hungarian"} ).text( 'Magyar£®–Ÿ—¿¿˚”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "italian"} ).text( 'Italiano£®“‚¥Û¿˚”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "japanese"} ).text( '»’±æ’Z£®»’”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "koreana"} ).text( '???£®∫´”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "norwegian"} ).text( 'Norsk£®≈≤Õ˛”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "polish"} ).text( 'Polski£®≤®¿º”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "portuguese"} ).text( 'Portugu®∫s£®∆œÃ——¿”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "brazilian"} ).text( 'Portugu®∫s-Brasil£®∆œÃ——¿”Ô-∞ÕŒ˜£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "russian"} ).text( 'ß≤ßÂß„ß„ß‹ß⁄ß€£®∂Ì”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "romanian"} ).text( 'Rom?n?£®¬ﬁ¬Ìƒ·—«”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "spanish"} ).text( 'Espa?ol£®Œ˜∞‡—¿”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "swedish"} ).text( 'Svenska£®»µ‰”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "tchinese"} ).text( '∑±Ûw÷–Œƒ£®∑±ÃÂ÷–Œƒ£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "thai"} ).text( '???£®Ã©”Ô£©' )
        );
        $SelectBox.append(
            $J('<option/>', {value: "turkish"} ).text( 'T®πrk?e£®Õ¡∂˙∆‰”Ô£©' )
        );
        ...
        Modal = ShowConfirmDialog( '∏¸∏ƒ”Ô—‘', $LanguageForm, '∏¸∏ƒ”Ô—‘' ).done( fnChangeLanguage );
        $SelectBox.focus();
    });
}
