...
GHomepage = {
        ...
        $J('.tab_item').each(function(i, j){
            ...
            if( unAppId && GStoreItemData.rgAppData[ unAppId ] )
            {
                ...
                if( rgData.tags )
                {
                    ...
                    {
                        var url = GStoreItemData.AddNavEventParamsToURL( 'http://store.steampowered.com/tags/zh-cn/TAGNAME/'.replace( /TAGNAME/, encodeURIComponent( rgData.tags[i] ) ), 'tab-preview' );
    ...
    RenderRecommendedTags: function()
    {
        ...
        for ( var i = 0; i < GDynamicStore.s_rgRecommendedTags.length; i++ )
        {
            ...
            {
                var url = GStoreItemData.AddNavEventParamsToURL( 'http://store.steampowered.com/tags/zh-cn/TAGNAME/'.replace( /TAGNAME/, encodeURIComponent( rgTag.name ) ), 'gutter' );
